...
using System.Web;
    ...
    public SqlDataReader GetDataReader(string commandText, List<SqlParameter> parameters)
    {
        return GetSqlDataReader(commandText, parameters);
    }
    public SqlDataReader GetDataReader(string commandText)
    {
        return GetSqlDataReader(commandText, new List<SqlParameter>());
    }
    private SqlDataReader GetSqlDataReader(string commandText, List<SqlParameter> parameters)
    {
