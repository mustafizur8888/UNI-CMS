...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="form-group col-lg-offset-1 col-md-offset-1">
            <label for="txtArtistName" class="col-lg-2 col-md-2 control-label text-right">Artist Name</label>
            <div class="col-lg-4 col-md-6">
                <asp:TextBox runat="server" CssClass="form-control" ID="txtArtistName"></asp:TextBox>
            </div>
            ...
            <asp:GridView ID="grdArtistName" runat="server" CssClass="table table-striped table-hover  table-condensed " AutoGenerateColumns="False" GridLines="None">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Artist Name">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lblAirtistName" Text='<%# Bind("Name") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
