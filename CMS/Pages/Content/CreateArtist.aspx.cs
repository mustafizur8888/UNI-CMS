...
namespace CMS.Pages.Content
{
    public partial class CreateArtist : System.Web.UI.Page
    {
        ...
        protected void btnEdit_OnClick(object sender, EventArgs e)
        {
            ...
            string PortalName = ((Label)gvr.FindControl("lblAirtistName")).Text;
        ...
        protected void btnDelete_OnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                count = _db.ExecuteNonQuery("sp_SetAirtiatName", sqlParameters);
            }
        ...
        protected void btnSave_OnClick(object sender, EventArgs e)
        {
            if (Validation())
            {
                ...
                string PortalName = txtArtistName.Text;
                ...
                List<SqlParameter> sqlParameters = new List<SqlParameter>
                {
                    ...
                    new SqlParameter{Value = PortalName,ParameterName = "@AirtistName"},
                ...
                hidPortalId.Value = "";
                int count = _db.ExecuteNonQuery("sp_SetAirtiatName", sqlParameters);
                if (count > 0)
                {
        ...
        private void LoadPortalName()
        {
            ...
            DataSet ds = null;
            ds = _db.GetDataSet("sp_SetAirtiatName", sqlParameters);
