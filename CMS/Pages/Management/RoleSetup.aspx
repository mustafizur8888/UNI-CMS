...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="form-group col-lg-offset-1 col-md-offset-1">
            <label for="txtRoleName" class="col-lg-2 col-md-2 control-label text-right">Role Name</label>
            <div class="col-lg-4 col-md-6">
                <asp:TextBox runat="server" CssClass="form-control" ID="txtRoleName"></asp:TextBox>
            </div>
            ...
            <asp:GridView ID="grdRole" runat="server" CssClass="table table-striped table-hover  table-condensed " AutoGenerateColumns="False" GridLines="None">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="RoleName">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lblRoleName" Text='<%# Bind("RoleName") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
