<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="CMS.Pages.Management.Login" %>
...
<div id="login-container" class="animation-fadeIn">
            ...
            <div class="form-group">
                <div class="col-xs-12">
                    <div class="input-group">
                        ...
                        <input type="text" id="txtUserName" runat="server" class="form-control input-lg" placeholder="UserName"/>
            ...
            <div class="form-group">
                <div class="col-xs-12">
                    <div class="input-group">
                        ...
                        <input type="password" id="txtPassword" runat="server" class="form-control input-lg" placeholder="Password"/>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xs-8 text-right">
                    <div>
                        <form runat="server">
                            ...
                            <asp:Button runat="server" ID="btnSubmit" Text="Login to Dashboard" Font-Italic="True" OnClick="btnSubmit_OnClick" class="btn btn-sm btn-primary"/>
                    ...
                    <%--<input type="button" id="btnBeforeOk" class="btn btn-sm btn-primary" value="Login to Dashboard" runat="server"  name="btnBeforeOk" OnServerClick="btnBeforeOk_OnServerClick" />--%>
                    <%--<button type="submit" class="btn btn-sm btn-primary" runat="server" id="btnSubmit" onclick=""/>--%>
    ...
    <footer class="text-muted text-center">
        <small><span id="year-copy"></span> &copy; <a href="http://goo.gl/TDOSuC" target="_blank">ProUI 3.6</a></small>
    </footer>
    <!-- END Footer -->
</div>
<!-- END Login Container -->
